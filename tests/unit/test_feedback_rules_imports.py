"""src/services/feedback_rules.py の依存の軽さを別プロセスで確かめる番人テスト。

feedback_rules は hook から直接importされるため、numpy・yoyo・sqlite_vec・src.db
...
_CHECK_SCRIPT = (
    "import sys\n"
    "import src.services.feedback_rules\n"
...
def test_importing_feedback_rules_does_not_pull_heavy_dependencies():
    ...
    assert hits == [], f"feedback_rules の import が重い依存を引き込んだ: {hits}"
