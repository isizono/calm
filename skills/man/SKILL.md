...
作業中のAIがあなたに聞きたいことがあるけど、すぐに答える必要はない——そういうときにAIはその問いをAsk storeに登録する。あなたは手が空いたタイミングで、`/ask-watch`をつけた別のClaude Codeセッションで、その問いを確認する。答えると、元の作業をしていたセッションにその判断が伝わり、AIはそれを踏まえて作業を続ける。
