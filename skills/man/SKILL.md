...
作業中のAIがあなたに聞きたいことがあるけど、すぐに答える必要はない——そういうときにAIはその問いをAsk storeに登録する。次にどのセッションを開いても、起動した瞬間にその問いが自然と目に入る。手元で監視したい場合は`/ask-watch`をつけた別セッションを立てておくこともできるが、これは無くても導線が閉じる補助的な機能。答えると、元の作業をしていたセッションにその判断が伝わり、AIはそれを踏まえて作業を続ける。
