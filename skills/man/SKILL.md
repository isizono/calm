...
- **`<定期監視スキル>`** — （cc-memory本体とは別の個人スキル）Ask storeを定期的に監視し、同型の問いが繰り返されていないか確認する。名前は環境によって異なる
...
作業中のAIがあなたに聞きたいことがあるけど、すぐに答える必要はない——そういうときにAIはその問いをAsk storeに登録する。あなたは手が空いたタイミングで、`<定期監視スキル>`（cc-memory本体とは別の個人スキル）をつけた別のClaude Codeセッションで、その問いを確認する。答えると、元の作業をしていたセッションにその判断が伝わり、AIはそれを踏まえて作業を続ける。

つまり「今すぐ答えなくていい判断」を、あなたの好きなタイミングで拾えるようにする仕組み。

### 基本の使い方

- 判断待ちが溜まっていないか気になったら「asks見せて」とAIに聞けばいい
